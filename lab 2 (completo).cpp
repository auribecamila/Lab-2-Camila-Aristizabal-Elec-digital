...
void setup()
{
  ...
  // Para calibrar el sensor capacitivo
  Serial.begin(115200);
}
...
void loop()
{
  ...
  // Descomentar para ver el valor del sensor en el Monitor Serial
  //Serial.println(touchRead(B3));

  if (touchRead(B3) < umbral)
  {
